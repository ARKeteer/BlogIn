  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
		...
		<div class="span3 affix">
          <div class="well sidebar-nav">
            <ul class="nav nav-list bs-docs-sidenav">
				...
				<li class="active"><a href="#">Reading list</a></li>
		...
		<div class="span9 well well-small pull-right">
            <div class="row-fluid">
				<div class="span9">
					<h3>Post title</h3>
				</div>
				<div class="span3">
					<br>
					<a href="#feed" class="btn btn-primary pull-right" data-toggle="modal" role="button">Read more &raquo;</a>
				</div>
			</div>
			<p>Summary of post. Lorem Ipsum dollar sit amet and other Lorem Ipsum dollar sit amet. After that again we will do Lorem Ipsum dollar sit amet which is possible with Lorem Ipsum dollar sit amet.</p>
        </div>
		<div class="span9 well well-small pull-right">
            <div class="row-fluid">
				<div class="span9">
				...
				<div class="span3">
					<br>
					<button class="btn btn-primary pull-right">Read more &raquo;</button>
				</div>
			</div>
			<p>Summary of post. Lorem Ipsum dollar sit amet and other Lorem Ipsum dollar sit amet. After that again we will do Lorem Ipsum dollar sit amet which is possible with Lorem Ipsum dollar sit amet.</p>
        </div>
...
<!-- DO NOT EDIT BELOW -->
	...
	<div id="feed" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="feedLabel" aria-hidden="true">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			<h3 id="feedLabel">Manage feeds</h3>
		</div>
		<div class="modal-body well">
			<div class="input-append">
				<input type="text" class="input span5" id="input04">             
				<button><i class="icon-trash"></i></button>
			</div>
			<div class="input-append">
				<input type="text" class="input span5" id="input04">             
				<button class="add-on button"><i class="icon-trash"></i></button>
			</div>
			<div class="input-append">
				<input type="text" class="input span5" id="input04">             
				<button class="add-on button"><i class="icon-trash"></i></button>
